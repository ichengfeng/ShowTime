...
#define XCLS(key)   NSLocalizedString(key, nil)

/// 安全获取字符串
/// @param str 字符串
NSString * _Nonnull SafeStr(_Nullable id str);

/// 安全获取字符串
/// @param str 字符串
/// @param defStr 不合法时返回的默认值
NSString * _Nonnull SafeStrDef(_Nullable id str, NSString * _Nullable defStr);
...
/// 获取图片的尺寸参数 https://test-static.xinc818.com/item/test.jpg?_w=790&_h=994
- (CGSize)imageSize;
